        ...
        softskills: [
            {
                ...
                explanation: "Use STAR method: 1) Situation: Describe the challenging team member and specific behaviors, 2) Task: Your role and what needed to be accomplished, 3) Action: Specific steps you took to address the issue (communication, conflict resolution, setting boundaries), 4) Result: Outcome and what you learned about working with difficult people."
            },
            {
                questionText: "Describe a situation where you had to give constructive feedback to a colleague. How did you approach it?",
                explanation: "Cover: 1) The specific situation requiring feedback, 2) How you prepared for the conversation, 3) Your approach to delivering the feedback (timing, tone, method), 4) How you ensured it was constructive and actionable, 5) The outcome and relationship afterward."
            },
            {
                questionText: "Give me an example of when you had to adapt your communication style to work effectively with someone. What did you do?",
                explanation: "Include: 1) The person and their communication style, 2) How it differed from yours, 3) Specific adaptations you made, 4) Tools or techniques you used, 5) The result and what you learned about flexible communication."
            },
            {
                questionText: "Tell me about a time when you had to influence someone without authority. How did you approach it?",
                explanation: "Discuss: 1) The situation and who you needed to influence, 2) Why you didn't have direct authority, 3) Your strategy for building influence (relationship building, expertise, data), 4) Specific tactics you used, 5) The outcome and lessons about influence without authority."
            },
            {
                questionText: "Describe a situation where you had to manage a conflict between team members. How did you resolve it?",
                explanation: "Address: 1) The nature of the conflict and parties involved, 2) Your role in the situation, 3) Your approach to understanding all perspectives, 4) Steps you took to facilitate resolution, 5) The outcome and how you prevented similar conflicts."
            }
        ]
    };
...
const createInterview = asyncHandler(async (req, res) => {
    ...
    if (!['technical', 'behavioral', 'softskills'].includes(category)) {
        category = 'technical';
    }
